...
goog.provide('proto.grpc.gateway.testing.ServerStreamingEchoRequest');
...
proto.grpc.gateway.testing.ServerStreamingEchoRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    messageInterval: (f = msg.getMessageInterval()) && proto.google.protobuf.Duration.toObject(includeInstance, f)
  };
